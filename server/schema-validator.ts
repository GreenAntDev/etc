interface IDictionary {
    [key: string] : string|number|boolean|Array<any>|undefined|null;
}
...
export interface SchemaEntry {
    ...
    range?: Array<string|number>|IDictionary,
    tags?: Array<string>,
    constraints?: Array<Function>,
    value?: string|number|boolean|Array<any>|undefined|null
}

export function validateObject(schema: Array<SchemaEntry>, obj: IDictionary, tags: Array<string>) {
    let errors:IDictionary|null = null;
    for (let field of schema) {
        try {
            // Check tags
            if (field.tags && tags) {
                let items = tags.filter(tag => field.tags?.includes(tag));
            ...
            if (field.type == 'array') {
                ...
                const range = field.range as IDictionary;
